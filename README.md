...
| NiceOS NGINX Exporter | `docker.io/niceos/nginx-exporter:1.5.1-niceos13-r1` | `ghcr.io/niceos-containers/nginx-exporter:1.5.1-niceos13-r1` | Nginx Exporter 1.5.1 | `bitnami/nginx-exporter/1/debian-12` |
...
```console
docker run --rm docker.io/niceos/nginx-exporter:1.5.1-niceos13-r1 nginx-exporter --version
docker run --rm ghcr.io/niceos-containers/nginx-exporter:1.5.1-niceos13-r1 nginx-exporter --version
```
...
| NiceOS NGINX Exporter | `docker.io/niceos/nginx-exporter@sha256:e25c8919846566a5cc4a284ce44c327f28c741612033282bd13c3a7233899e20` | `ghcr.io/niceos-containers/nginx-exporter@sha256:e25c8919846566a5cc4a284ce44c327f28c741612033282bd13c3a7233899e20` |
...
- `nginx-exporter`: `docker.io/niceos/nginx-exporter:1.5.1-niceos13-r1` / `ghcr.io/niceos-containers/nginx-exporter:1.5.1-niceos13-r1`
